...
public class StorageKeyTests
{
    ...
    public void ToStorageKey_FormatIsYyyyMMddHHmmss()
    {
        ...
        Assert.Equal("2024-03-15 08:30:00", TwelveDataParamExtensions.ToStorageKey(dt));
    }
    ...
    public void ToStorageKey_MidnightDateTime_ProducesCorrectString()
    {
        ...
        Assert.Equal("2024-01-01 00:00:00", TwelveDataParamExtensions.ToStorageKey(dt));
    }
    ...
    public void ToStorageKey_NonMidnightDateTime_PreservesHoursMinutes()
    {
        ...
        Assert.Equal("2024-06-20 16:00:00", TwelveDataParamExtensions.ToStorageKey(dt));
    }

    [Fact]
    public void ParseStorageKey_ValidString_ParsesCorrectly()
    {
        var result = TwelveDataParamExtensions.ParseStorageKey("2024-03-15 08:30:00");
    ...
    public void ParseStorageKey_RoundTrip_MatchesOriginal()
    {
        ...
        var key = TwelveDataParamExtensions.ToStorageKey(original);
        var parsed = TwelveDataParamExtensions.ParseStorageKey(key);
    ...
    public void ParseStorageKey_InvalidFormat_ThrowsFormatException()
    {
        Assert.Throws<FormatException>(() =>
            TwelveDataParamExtensions.ParseStorageKey("2024/01/01"));
    }
    ...
    public void ToStorageKey_ThenParseStorageKey_SecondsPreserved()
    {
        ...
        var roundTripped = TwelveDataParamExtensions.ParseStorageKey(
            TwelveDataParamExtensions.ToStorageKey(original));
