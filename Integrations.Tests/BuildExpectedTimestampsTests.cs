...
public class BuildExpectedTimestampsTests
{
    ...
    {
        var result = TwelveDataParamExtensions.BuildExpectedTimestamps(Base, Base.AddDays(2), "4h");
    ...
    {
        var result = TwelveDataParamExtensions.BuildExpectedTimestamps(Base, Base.AddDays(1), "4h");
    ...
    public void BuildExpectedTimestamps_EndOnIntervalBoundary_ExcludesLastIncompleteStep()
    {
        ...
        var result = TwelveDataParamExtensions.BuildExpectedTimestamps(start, end, "4h");
    ...
    public void BuildExpectedTimestamps_StartEqualsEnd_ReturnsSingleEntry()
    {
        ...
        var result = TwelveDataParamExtensions.BuildExpectedTimestamps(Base, Base, "4h");
        Assert.Single(result);
        Assert.Equal(Base, result[0]);
    }
    ...
    public void BuildExpectedTimestamps_1dayInterval_CorrectCount()
    {
        ...
        var result = TwelveDataParamExtensions.BuildExpectedTimestamps(start, end, "1day");
